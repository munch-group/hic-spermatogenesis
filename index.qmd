...
- What data do we have/can we get
- What about human spermatogenesis data? 
    - [@shami_single-cell_2020] did have 4 human testes samples, but didn't do Hi-C 
...
- Is is probably not possible to obtain data from human spermatogenesis. 
