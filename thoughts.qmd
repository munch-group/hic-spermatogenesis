...
{{< embed notebooks/03_compartments.ipynb#chrX-matrix-e1-500kb >}}

Or the full size E1 plot:

{{< embed notebooks/03_compartments.ipynb#chrX-e1-500kb-plot >}}

To ease the eye, here are the 100kb E1 and 500kb E1 plots next to each other:

**500kb resolution:** {{< embed notebooks/03_compartments.ipynb#chrX-e1-500kb-plot >}}

**100kb resolution** {{< embed notebooks/02_open2c_framework.ipynb#chrX-e1-plot >}}
...
Then, the E1 for each cell type was plotted andlooks like we have succesfully reproduced the A/B compartments from [@wang_reprogramming_2019]. Also, I noticed after all this, that they also partition the chromosomes at the centromere. The more you know...

{{< embed notebooks/03_compartments.ipynb#e1-fullmerged-all-500kb >}}

After plotting the values from the 'chromosome-wide' E1, i wanted to see how it was affected by subtraction of the running average. It might produce similar results for one or two cell types, but we do not want a specific method for each cell type. 

{{< embed notebooks/03_compartments.ipynb#e1-fullmerged-all-500kb-running-avg >}}
