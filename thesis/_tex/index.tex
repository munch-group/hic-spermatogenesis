...
tissue types. pc\_scale is the viewframe used for the compartment
calling. All insignificant p-values are filtered out. \emph{Fb:
Fibroblast, Spa: Spermatogonia, Pac: Pachytene Spermatocyte, RS: Round
Spermatid, Sperm: Sperm}}

\centering{

\subcaption{\label{tbl-svedig-tabel-significant-1}Arms viewframe}

\centering{

\begin{tabular}{llllll}
\toprule
~ & tissue & Fb & Spa & Pac & RS\\
\midrule
test & query & ~ & ~ & ~ & ~\\
jaccard & ECH90 & 0.017 & 0.006 & 0.005 & 0.028\\
proximity & olivehama & nan & nan & 0.036 & nan\\
\bottomrule
\end{tabular}

}

\subcaption{\label{tbl-svedig-tabel-significant-2}10Mb viewframe}

\centering{

\begin{tabular}{llllll}
\toprule
~ & tissue & Fb & Spa & Pac & Sperm\\
\midrule
test & query & ~ & ~ & ~ & ~\\
jaccard & ECH90 & 0.021 & 0.006 & nan & 0.048\\
proximity & olive & nan & nan & nan & 0.016\\
 & olivehama & nan & 0.019 & 0.012 & 0.001\\
\bottomrule
\end{tabular}
...
\bibitem[\citeproctext]{ref-batra2020accurateassemblyolive}
...
\bibitem[\citeproctext]{ref-munch2016selectivesweepstwenty}
...
\bibitem[\citeproctext]{ref-skov2017analysis62hybrid}
