...
%% Tables
% \usepackage[style=plaintop, capposition=top]{floatrow}
...
analysis, including figures and tables in only 3 lines of code and a HPC
cluster (see Table~\ref{tbl-reproducibility} for a brief overview):
