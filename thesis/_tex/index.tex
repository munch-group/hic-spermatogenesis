...
\includegraphics[width=2.94792in,height=2.05208in]{index_files/figure-latex/..-notebooks-06_rec_genomicintervals-fig-proximity-jaccard-bar-output-1.png}

}

\subcaption{\label{fig-proximity-jaccard-bar}Proximity and Jaccard index
