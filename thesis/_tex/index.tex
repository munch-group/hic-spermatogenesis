...
\emph{The conventional story of meiosis in gametogenesis is one of
...
on the X chromosome create a disadvantage for gametes that }do not*
...
Ecosystem} ({``Open {Chromosome Collective} ({Open2C})''} n.d.) which
have a Pyton API as well as command-line functions, which can be paired
very well with Jupyter Notebooks. The majority of the data analysis was
run with a \emph{gwf} workflow, and the commands that were visually
inspected were run in Jupyter Notebooks.
