...
tools for rescuing chimeric reads. That said, we have to be cautious
...
\item[$\boxtimes$]
  ...
  \href{https://pairtools.readthedocs.io/en/stable/protocols_pipelines.html\#recommended-pairtools-parameters-for-standard-hi-c-protocols}{docs}
\end{itemize}
...
parsing, as the deduplication step requires a sorted set of pairs.
...
they have closed 99\% of the gaps since \emph{rhemac8} {[}ref{]},
\emph{rheMac10} still contain more than 2,500 unplaced scaffolds, which
