...
Section~\ref{sec-matrix-qc}.

\includegraphics[width=0.7\linewidth,height=1\textheight]{illustrations/placeholder2000x360.png}

Overview of the target templates used for hicexplorer. As most
operations are handled by \texttt{hicBuildMatrix}, it is rather simple.
...
%
\begin{minipage}{0.33\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{../figures/bowtie2/local/normalized/pc3_50kb_corrected_chrX.png}}\end{minipage}%
\newline
\begin{minipage}{0.33\linewidth}
