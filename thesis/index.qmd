...
- [x] synteny on chrX
- [x] Selective sweeps (or is it?) in humans (ECH90; @skov2023extraordinaryselectionhuman)
- [x] Negative selection in baboons w.r.t. minor parent ancestry
- [x] Erik: Negative selection against Admixture
- [x] Draw a parallel to Human/Neanderthal
...
- [x] Chromatin organization is highly conserved between species
- [x] Explain why take offset in @wang2019reprogrammingmeioticchromatin
- [ ] Exlpain the rationale of reproducing results with the latest reference
- [x] Explain why it makes sense to compare these datasets
- [x] The low-diveristy in *P.hamadryas* and ECH are very wide - chromatin has same window size?? 
