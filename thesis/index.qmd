...
-   [ ] Negative selection in baboons w.r.t. minor parent ancestry
    ...
    -   [ ] The low-diveristy in *p.hamadryas* are very wide - chromatin has same window size?? 
- [ ] Erik: Negative selection against Admixture
- [ ] Draw a parallel to Human/Neanderthal

## Chromatin Architecture

> Understanding how chromosomes fold can provide insight into the complex relationships between chromatin structure, gene activity, and the functional state of the cell. Yet beyond the scale of nucleosomes, little is known about chromatin organization 
>   --- @lieberman-aiden2009comprehensivemappinglongrange
