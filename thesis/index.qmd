...
The X chromosome plays a unique role in evolution, being directly exposed to selection pressures due to its hemizygosity in males, leading to unique inheritance patterns. Regions of reduced diversity on the X chromosome could reflect the influence of strong evolutionary forces. Chromatin architecture, particularly the organization into A/B compartments, may provide insights into the functional basis of these patterns.

Here, we analyze the 3D chromatin structure of the X chromosome in rhesus macaque using Hi-C data on the latest reference genome (rheMac10). Our analysis extensively combines software tools that emphasize reproducibility, ensuring that our analyses are transparent, portable, and replicable.
