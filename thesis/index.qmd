...
::: {#fig-explorer-pre-correction layout="[[-5,25,25,25,-5], [-5,25,25,-30]]"}
...
Histograms of the number of counts per bin (bottom) and the modified z-score (top) from which the *mad* threshold is defined.
:::
...
![Normalized matrix](../figures/bowtie2/local/filter_pooled_50kb_chrX.png){#fig-explorer-pooled-chrX-norm}

![Normalized and corrected](../figures/bowtie2/local/normalized/normsm_filter_pooled_100kb_corrected_chrX-1-105Mb.png){#fig-explorer-pooled-chrX-normcorr}
